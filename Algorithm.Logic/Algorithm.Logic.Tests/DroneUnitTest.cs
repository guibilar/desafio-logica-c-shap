...
namespace Algorithm.Logic.Tests
{
    ...
    public class DroneUnitTest
    {
        ...
        {
            //(CORREÇÃO, UMA ENTRADA N123LSX RESULTA EM (123,1)) O TESTE ESTÁ ERRADO
        ...
        {
            //(CORREÇÃO, UMA ENTRADA NNNXLLLXX RESULTA EM (2,1)) O TESTE ESTÁ ERRADO
        ...
        {
            //(CORREÇÃO, UMA ENTRADA N2147483647XN RESULTA EM (0,1)) O TESTE ESTÁ ERRADO
